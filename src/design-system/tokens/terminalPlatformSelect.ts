...
export const terminalPlatformSelect = {
  ...
  trigger:
    "flex items-center gap-2 rounded-full border border-[#242424] bg-black py-1.5 pr-2.5 pl-2 text-control font-medium text-ink shadow-none outline-none transition-colors hover:bg-[#0d0d0d] focus-visible:ring-2 focus-visible:ring-[#f2b500]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-black",
  ...
  menuItem:
    "flex w-full items-center gap-2.5 px-3 py-2 text-left text-control text-ink transition-colors hover:bg-white/[0.06]",
