 ...
 */
export default function VaultGridCard({ vault, ui, onPatch }) {
  ...
  return (
    <div
      className="vaults-root flex flex-col gap-3 rounded-xl border border-[rgba(255,255,255,0.06)] p-4 shadow-[0_4px_20px_-5px_rgba(0,0,0,0.35)]"
      style={{
        backgroundImage:
