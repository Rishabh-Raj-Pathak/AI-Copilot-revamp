    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
      <div className="max-w-md rounded-xl border border-[#242424] bg-[#121212] p-6 shadow-2xl">
        ...
        <p className="mt-3 text-sm leading-relaxed text-[#bfbfbf]">
          This demo shows AI-suggested trade setups alongside execution
          controls. Browse filters, review the highlighted setup and chart, then
          adjust the order panel before simulating execution.
        </p>
        <ul className="mt-4 list-none space-y-1 text-sm text-[#242424]">
