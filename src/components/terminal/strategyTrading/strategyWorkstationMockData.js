...
export const INITIAL_WORKSTATION_STRATEGIES = [
  ...
  buildStrategyRecord({
    ...
    prompt: "ETH breakout momentum on 1h",
    backtestComplete: true,
    lastUpdated: "2h ago",
    sortOrder: 120,
  }),
  buildStrategyRecord({
    id: "strat-sol-scalper",
    name: "SOL Range Scalper",
    status: "Draft",
    modelId: "quant",
    strategyId: "mean-reversion",
    marketId: "sol",
    marketLabel: "SOLUSDT · 5m",
    prompt: "SOL range scalper on 5m",
    lastUpdated: "5h ago",
    sortOrder: 300,
  }),
  buildStrategyRecord({
    id: "strat-eth-trend-draft",
    name: "ETH Trend Continuation",
    status: "Draft",
    modelId: "aggressive",
    strategyId: "trend-following",
    marketId: "eth",
    marketLabel: "ETHUSDT · 1h",
    prompt: "ETH trend continuation draft",
    lastUpdated: "2h ago",
    sortOrder: 130,
  }),
  buildStrategyRecord({
    id: "strat-sol-breakout-draft",
    name: "SOL Breakout Scalper",
    status: "Draft",
    modelId: "aggressive",
    strategyId: "momentum-breakout",
    marketId: "sol",
    marketLabel: "SOLUSDT · 5m",
    prompt: "SOL breakout scalper draft",
    lastUpdated: "1d ago",
    sortOrder: 1440,
  }),
  buildStrategyRecord({
