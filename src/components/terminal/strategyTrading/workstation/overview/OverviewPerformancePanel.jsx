...
export default function OverviewPerformancePanel({ bt }) {
  return (
    <div className="rounded-xl border border-[#2a2a2a] bg-[#141414] p-4 sm:p-5">
      ...
      <p className="mt-4 text-[10px] font-semibold uppercase tracking-wide text-[#585858]">
        Profit
      </p>
      ...
      <p className="mt-6 text-[10px] font-semibold uppercase tracking-wide text-[#585858]">
        Risk
      </p>
      <div className="mt-2 grid gap-4 sm:grid-cols-2 sm:gap-6">
        <MetricColumn>
          <OverviewStatRow
            ...
            valueTone="negative"
          />
          <OverviewStatRow label="Sortino Ratio" value={bt.sortinoRatio ?? "—"} />
        </MetricColumn>
        <MetricColumn>
